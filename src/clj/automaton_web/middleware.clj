...
(defn wrap-exception-handling
  ...
  * (optional) `body` - defaults to building internal error page, but could be supplied with anything suitable."
  ([handler]
   (fn
     ([request] (wrap-exception-handling* handler request #(http-response/internal-server-error (error-pages/internal-error-page request))))
     ([request respond raise]
      (wrap-exception-handling* handler
                                request
                                respond
                                raise
                                #(http-response/internal-server-error (error-pages/internal-error-page request))))))
  ([handler body]
   (fn
