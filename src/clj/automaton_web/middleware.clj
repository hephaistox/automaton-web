...
(defn- wrap-exception-handling*
  ...
  ([handler request respond raise body-fn]
   (try (handler request respond raise)
        (catch Exception e (core-log/error (ex-info "Fail in async middleware." {:error e})) (respond (body-fn)))
        (catch Error e (core-log/fatal (ex-info "Fail in async middleware." {:error e})) (respond (body-fn))))))
