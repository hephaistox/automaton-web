...
(def be-components-translator (be-tempura-translator/make-tempura-be-translator web-language/main-langs))
...
(defn tr
  ...
  * `resources` resources for the translation"
  ...
  (be-translator/translate-based-on-request be-components-translator http-request tr-id (vec resources)))
