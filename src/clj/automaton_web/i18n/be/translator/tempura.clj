(ns automaton-web.i18n.be.translator.tempura
  ...
  (:require [automaton-core.i18n.translator :as core-translator]
            [automaton-core.i18n.translator.tempura :as core-tempura]
...
(defrecord TempuraWebTranslator [translator]
  be-translator/BeTranslator
    (wrap-translator [this] (fn [handler] (tempura/wrap-ring-request (be-translator/wrap-ring-request this handler) {})))
    (translate-based-on-request [_
                                 {:keys [locales]
                                  :as _http-request} tr-id resources]
      (core-translator/translate translator locales tr-id resources))
    (language-choice-strategy [this http-request] (be-translator/lang-str-choice-strategy-def this http-request))
      ...
      (fn [{:keys [tempura/accept-langs_]
        ...
        (let [locales-str [(be-translator/language-choice-strategy web-translator http-request)]
          ...
          (-> updated-request
              (assoc :tr
                     (fn
                       ([tr-id resources] (be-translator/translate-based-on-request web-translator updated-request tr-id resources))
                       ([tr-id] (be-translator/translate-based-on-request web-translator updated-request tr-id nil))))
              handler
  ...
  core-translator/Translator
    ...
    (translate [_ lang-ids tr-id resources] (core-translator/translate translator lang-ids tr-id resources)))
...
(defn make-tempura-be-translator
  ...
  * `main-langs` is the ordered sequence of preffered language"
  [main-langs & dicts]
  (-> (apply core-tempura/make-translator main-langs automaton-web.i18n.dict.text/dict automaton-web.i18n.dict.resources/dict dicts)
