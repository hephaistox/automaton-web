(ns automaton-web.portfolio.components.button
  (:require [automaton-web.components.button :as sut]
...
(defscene button
          (web-proxy/wrap-component [sut/button
                                     {:text "Button"
...
#_{:clj-kondo/ignore [:clojure-lsp/unused-public-var]}
(defscene x-button (web-proxy/wrap-component [sut/x-button {:on-click #(js/alert "Hello")}]))
