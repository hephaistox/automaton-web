...
#_{:clj-kondo/ignore [:clojure-lsp/unused-public-var]}
(defscene checkbox-title (web-proxy/wrap-component [sut/checkbox {:title "Name"}]))

#_{:clj-kondo/ignore [:clojure-lsp/unused-public-var]}
(defscene checkbox-title-description
          (web-proxy/wrap-component [sut/checkbox
                                     {:title "Name"
...
(defscene checkbox-required
          (web-proxy/wrap-component [sut/checkbox
                                     {:title "Important to know"
                                      ...
                                      :required? true}]))
#_{:clj-kondo/ignore [:clojure-lsp/unused-public-var]}
(defscene checkbox-invalid (web-proxy/wrap-component [sut/checkbox {:invalid? true}]))
...
#_{:clj-kondo/ignore [:clojure-lsp/unused-public-var]}
(defscene checkboxes (web-proxy/wrap-component [sut/checkboxes {:title "Name"}]))

#_{:clj-kondo/ignore [:clojure-lsp/unused-public-var]}
(defscene checkboxes-more (web-proxy/wrap-component [sut/checkboxes {:title "Name"} {:title "Name"} {:title "Name"} {:title "Name"}]))

#_{:clj-kondo/ignore [:clojure-lsp/unused-public-var]}
(defscene checkboxes-description
          (web-proxy/wrap-component [sut/checkboxes
                                     {:title "Name"
                                      :description "This is important section to know about etc."}
                                     {:title "Name"
                                      :description "This is important section to know about etc."}
