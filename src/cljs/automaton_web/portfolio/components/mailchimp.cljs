...
(defscene mailchimp-failing-newsletter
          "Mailchimp failing newsletter modal (This will not result in any real mail address added to mailchimp)"
          (web-proxy/wrap-component (web-modal/wrap-modal-call {:modal-id sut/mailchimp-newsletter-modal-id}
...
(defscene mailchimp-newsletter
          ...
          (web-proxy/wrap-component (web-modal/wrap-modal-call {:modal-id (str "new-" sut/mailchimp-newsletter-modal-id)}
                                                               [web-button/button {:text "Open modal"}])
...
#_{:clj-kondo/ignore [:clojure-lsp/unused-public-var]}
(defscene mailchimp-gdpr-compliance [sut/mailchimp-gdpr-compliance {:lang :en}])
