...
(defscene structure (web-proxy/wrap-component [sut/structure {} [:div "Hello"]]))

#_{:clj-kondo/ignore [:clojure-lsp/unused-public-var]}
(defscene structure-header-footer
          (web-proxy/wrap-component [sut/structure
                                     {:header [:div "Header"]
                                      :footer [:div "Footer"]} [:div "Hello"]]))

#_{:clj-kondo/ignore [:clojure-lsp/unused-public-var]}
(defscene structure-fancy
          (web-proxy/wrap-component
           [sut/structure
            {:header [web-header/simple-header
                      {:logo "Logo"
                       :size :full
                       :right-section [:div "Login"]}]
             :footer [web-footer/simple-footer {:title "Hephaistox footer"}]} [:div {:class ["mt-20" "mb-5"]} "Body!"]
            [web-form/form-basic {}
