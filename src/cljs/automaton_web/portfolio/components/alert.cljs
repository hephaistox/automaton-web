(ns automaton-web.portfolio.components.alert
  (:require [automaton-web.components.alert :as sut]
...
#_{:clj-kondo/ignore [:clojure-lsp/unused-public-var]}
(defscene title-only (web-proxy/wrap-component [sut/component {:title "Title"}]))

#_{:clj-kondo/ignore [:clojure-lsp/unused-public-var]}
(defscene message-only (web-proxy/wrap-component [sut/component {:message "Message"}]))
