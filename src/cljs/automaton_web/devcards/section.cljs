...
(defcard
 section-description
 (bdu/wrap-component
  [:div [:h3 "description light"]
   [sut/section-description
    {:title "Title"
     :description
          ...
          [:div [:h3 "Short text"]
           [sut/section-text-button
            {:text "This is a text of this section"
             :btn-text "Click me!"}] [:h3 "Dark mode"]
           [:div {:class ["bg-gray-900"]}
            [sut/section-text-button
             {:text "This is a text of this section"
              :dark? true
              :btn-text "Click me!"}]] [:h3 "Long text"]
           [sut/section-text-button
            {:text
          ...
          [:div [:h3 "Short text"]
           [sut/section-text-video
            {:text "This is a text of this section"
             ...
             :video-src "https://www.youtube.com/embed/9EcjWd-O4jI"}] [:h3 "Long text"]
           [sut/section-text-video
            {:title "And this is quite long for a title"
             ...
             "This is a text of this section and when it's reaaaaaly long the button will be centered to fit this section text nicely."
             :btn-props {:text "Click me!"}
             :video-src "https://www.youtube.com/embed/9EcjWd-O4jI"}] [:h3 "Dark mode"]
           [sut/section-text-video
            {:text "This is a text of this section"
             :subtitle "Boombox"
             :title "PUMP IT UP!"
