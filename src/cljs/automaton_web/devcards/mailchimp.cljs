...
(defcard mailchimp-failing-newsletter
  (bdu/wrap-component
   [:div
    [:h3 "Mailchimp failing newsletter modal"]

    (bcm/wrap-modal-call {:modal-id sut/mailchimp-newsletter-modal-id}
                         [bcb/button
                          {:text "Open modal"}])
...
(defcard mailchimp-newsletter
  (bdu/wrap-component
   [:div
    [:h3 "Mailchimp successful newsletter modal (Will add email to audience)"]
    (bcm/wrap-modal-call {:modal-id (str
                                     "new-"
                                     sut/mailchimp-newsletter-modal-id)}
                         [bcb/button
                          {:text "Open modal"}])
...
#_{:clj-kondo/ignore [:clojure-lsp/unused-public-var]}
(defcard mailchimp-gdpr-compliance
  (bdu/wrap-component
