(ns automaton-web.devcards.menu
  (:require [automaton-web.components.menu :as sut]
...
(defcard
 menu
 (bdu/wrap-component
  [:div [:h1 {:class ["text-3xl"]} "Show normal menu, Menu2 is forced to be selected"]
   [sut/component
    {:items [{:title "Menu1"
   ...
   [:h1 {:class ["text-3xl"]} "Menu with auto select"]
   [sut/component
    {:items [{:title "Menu1"
              :href "/admin/devcards#!/automaton-web.devcards.menu"}
             {:title "Menu2"
   ...
   [:h1 {:class ["text-3xl"]} "Menu forced to be in burger mode"]
   [sut/component
    {:items [{:title "Menu1"
              :href "/admin/devcards#!/automaton-web.devcards.menu"}
             {:title "Menu2"
