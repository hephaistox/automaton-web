(ns automaton-web.i18n.fe.auto-web-translator
  ...
  (:require [automaton-web.i18n.fe.translator :as fe-translator]
...
(def fe-components-translator
  (fe-tempura-translator/make-fe-tempura-translator (partial web-language/ui-str-to-id web-language/automaton-web-languages)
...
(defn get-lang "Return the currently selected language" [] (fe-translator/lang fe-components-translator))
